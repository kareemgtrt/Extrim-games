...
setInterval(() => {
  http.get(`http://bot-games-3.glitch.me/`);
}, 280000);
...
🎮 - ${prefix}rps
---------------------------------**`)
.setFooter('Copy Right Reserved For: OP')
...
var statuss = ["@help","Thx for using Extrim GAMES"]; // بالإمكان اضافة المزيد بدون التعديل في الكود
...
client.on("ready", () =>{
	...
	setInterval(function(){
		...
		client.user.setActivity(statuss[num], {type: 'PLAYING', url: 'https://twitch.tv/Nil'})
	}, timeing)
});
